    ...
    async execute(interaction: ChatInputCommandInteraction) {
        try {
            ...
            if (!userData.faction.name) {
                ...
                log('Faction-Creer-Action Command', `${interaction.user.tag} tried to create shares but is not in a faction.`);
            ...
            if (!faction) {
                ...
                log('Faction-Creer-Action Command', `${interaction.user.tag} tried to create shares for a non-existent faction: ${factionName}.`);
                return interaction.reply({ embeds: [embed], ephemeral: true });
            }
            ...
            if (faction.president !== userId) {
                ...
                log('Faction-Creer-Action Command', `${interaction.user.tag} tried to create shares for ${factionName} but is not the president.`);
                return interaction.reply({ embeds: [embed], ephemeral: true });
            }
            ...
            if (nombre <= 0) {
                ...
                log('Faction-Creer-Action Command', `${interaction.user.tag} tried to create an invalid number of shares: ${nombre}.`);
                return interaction.reply({ embeds: [embed], ephemeral: true });
            }
            ...
            log('Faction-Creer-Action Command', `${interaction.user.tag} created ${nombre} shares for ${factionName}.`);
            ...
            console.error('Faction-Creer-Action Command Error:', e);
            log('Faction-Creer-Action Command Error', `Error occurred: ${String(e)}`);
